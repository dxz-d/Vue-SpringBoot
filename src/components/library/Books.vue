        ...
        <el-row style="height: 840px;">
            <el-tooltip effect="dark" placement="right"
                ...
                <el-card style="width: 135px; margin-bottom: 20px; height: 233px; float: left;
                    margin-right: 15px; margin-left:-25%" class="book" body-style="padding:10px" shadow="hover">
                    <div class="cover">
    ...
    export default {
        ...
        data() {
            return {
                books: [
                    {
                        cover: 'https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2346084289,4247793407&fm=26&gp=0.jpg',
                        title: '三体',
                        author: '刘慈欣',
                        data: '2019-01-01',
                        press: '重庆出版社',
